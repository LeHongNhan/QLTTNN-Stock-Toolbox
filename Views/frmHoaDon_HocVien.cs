...
namespace Views
{
    public partial class frmHoaDon_HocVien : Form
    {
        public frmHoaDon_HocVien()
        {
            InitializeComponent();
        }
        int maHS = -1;
        ...
        private void frmHoaDon_HocVien_Load(object sender, EventArgs e)
        {
            LoadDanhSachHocSinh();
        }
        int hocSinhID = -1;
